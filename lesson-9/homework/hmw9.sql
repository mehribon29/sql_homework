...
select *from Customers
select *from Sales
select c.CustomerID, c.FirstName, c.LastName,s.ProductID, s.SaleAmount
from Customers c 
join Sales s  on c.CustomerID=s.CustomerID
where s.SaleAmount>=150.00

14. 
select *from Enrollments
select *from Courses
select *from Students
select s.StudentID, s.Name, c.CourseName, e.CourseID 
from Enrollments e 
...
select *from Customers;
select *from Sales;
select c.FirstName, c.Country, s.ProductID
from Customers c
join Sales s on  c.CustomerID=s.CustomerID
where c.Country='USA'
...
select *from Orders
select *from Customers;
Select c.CustomerID, c.FirstName, c.Country, o.TotalAmount 
from Customers c
join Orders o on c.CustomerID=O.CustomerID
...
21.
select *from Employees
select e1.Name as Emp1, e1.DepartmentID as Dept1,
e2.Name as Emp2, e2.DepartmentID as Dept2
from Employees e1
